...
Query.prototype.update = function (conditions, doc, options, callback) {
  ...
  console.log('castQuery(this):', this);
...
Query.prototype.upsert = function (conditions, doc, options, callback) {
  ...
  if ('function' === typeof options) {
    ...
    this._mongooseOptions.upsert = conditions;
    return this;
  }
  console.log('UPSERT', this, '\nPARAMS:', '\n', conditions, '\n', doc, '\n', options, '\n', callback, '\nARGS: ', arguments);
  return this.update(conditions, doc, options, callback);
}
...
Query.prototype.exec = function exec (op, callback) {
  ...
  // NOTE: Should this be skipped if we have no this.schema? Or is that just idiotic?
  // this.find and this.update need a schema, right?
  // should this.op have a default?
  if (!this.op || !this.schema) {
    promise.complete();
    return promise;
  }
