 ...
 * ####Note:
 *
 * Be careful to not use an existing model instance for the upsert (this won't work and can cause weird behavior). Also, ensure that the upsert's change `doc` does not have an _id property, which causes Mongo to return a "Mod on _id not allowed" error.
 *
 * ####Note:
 *
